...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container">
                <h3 class="ml-2" style="color: black;">Kategori Artikel</h3>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a type="button" href="<?= base_url('Artikel/delete_kategori/') . $row->id_kategori; ?>" class="btn btn-primary btn-sm text-white">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
